...
if st.session_state.user_id is None:
    ...
    with col_left:
        html_intro = (
            ...
            "<p style='color: var(--text-secondary); font-size: 1.15rem; margin-bottom: 2rem;'>Hệ thống tìm kiếm bài báo khoa học & quản lý trích dẫn đa ngành thông minh.</p>"
            ...
            "      <p style='margin: 0; font-size: 0.85rem; color: var(--text-secondary); line-height: 1.5;'>Gõ bất kỳ từ khóa (tiếng Việt/tiếng Anh), tác giả hay mã DOI. Trí tuệ nhân tạo (AI) sẽ tự động tối ưu hóa và dịch thuật truy vấn của bạn.</p>\n"
            "    </div>\n"
            "  </div>\n"
            
            "  <div style='background: linear-gradient(135deg, rgba(124, 58, 237, 0.15), rgba(249, 115, 22, 0.1)); border: 1px solid rgba(124, 58, 237, 0.35); border-radius: var(--radius); padding: 1.25rem; display: flex; gap: 1rem; align-items: flex-start;'>\n"
            "    <div style='font-size: 1.8rem; line-height: 1;'>🌟</div>\n"
            "    <div>\n"
            "      <h4 style='margin: 0 0 0.25rem 0; color: #fb923c; font-weight: 700; display: flex; align-items: center; gap: 6px;'>Lọc & Tra cứu Scopus & WoS <span style='font-size: 0.7rem; background: #6c63ff; color: white; padding: 2px 6px; border-radius: 4px; font-weight: 600;'>Độc quyền</span></h4>\n"
            "      <p style='margin: 0; font-size: 0.85rem; color: var(--text-primary); line-height: 1.5;'>Tra cứu chuẩn xác qua cơ sở dữ liệu xác thực tĩnh hơn 170.000 tạp chí và đối khớp đa tầng bằng mã ISSN & Chuẩn hóa tên. Giúp phân loại bài báo chuẩn Scopus (Q1-Q4) và Web of Science.</p>\n"
            "    </div>\n"
            "  </div>\n"
            ...
            "      <p style='margin: 0; font-size: 0.85rem; color: var(--text-secondary); line-height: 1.5;'>Tích hợp cơ chế quét đa nguồn (Unpaywall, OpenAlex, Semantic Scholar) để tìm kiếm và tải trực tiếp file PDF Open Access của các bài viết trả phí.</p>\n"
            "    </div>\n"
            "  </div>\n"
            ...
            "      <p style='margin: 0; font-size: 0.85rem; color: var(--text-secondary); line-height: 1.5;'>Trích xuất nhanh mục tiêu (Objectives), phương pháp luận (Methodology) và kết quả chính (Key Findings) của tài liệu qua Google Gemini AI.</p>\n"
            "    </div>\n"
            "  </div>\n"
            ...
            "      <p style='margin: 0; font-size: 0.85rem; color: var(--text-secondary); line-height: 1.5;'>Lưu trữ tài liệu yêu thích vào thư viện riêng tư. Hỗ trợ định dạng trích dẫn chuẩn APA 7th, MLA 9th, Chicago và xuất danh mục ra Excel/CSV.</p>\n"
            "    </div>\n"
            "  </div>\n"
